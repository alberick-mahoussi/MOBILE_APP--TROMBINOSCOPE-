...
var _createTabNavigator = require('./createTabNavigator');
...
var _ResourceSavingScene = require('./ResourceSavingScene');
  ...
  function TabNavigationView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TabNavigationView.__proto__ || Object.getPrototypeOf(TabNavigationView)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (typeof label === 'function') {
        return label({ focused: focused, tintColor: tintColor });
      }
      ...
      return _react2.default.createElement(TabBarComponent, _extends({}, tabBarOptions, { jumpTo: _this._jumpTo, navigation: navigation, screenProps: screenProps, onTabPress: onTabPress, getLabelText: getLabelText, renderIcon: renderIcon }));
        ...
        _react2.default.createElement(
          ...
          routes.map(function (route, index) {
            ...
            return _react2.default.createElement(
              ...
              { key: route.key, style: [_reactNative.StyleSheet.absoluteFill, { opacity: isFocused ? 1 : 0 }], isFocused: isFocused },
