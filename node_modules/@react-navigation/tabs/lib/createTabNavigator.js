...
function createTabNavigator(TabView) {
  var NavigationView = function (_React$Component) {
    ...
    function NavigationView() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = NavigationView.__proto__ || Object.getPrototypeOf(NavigationView)).call.apply(_ref, [this].concat(args))), _this), _this._renderScene = function (_ref2) {
        ...
        return _react2.default.createElement(_core.SceneView, { screenProps: screenProps, navigation: descriptor.navigation, component: TabComponent });
        ...
        if (options.tabBarIcon) {
          return typeof options.tabBarIcon === 'function' ? options.tabBarIcon({ focused: focused, tintColor: tintColor }) : options.tabBarIcon;
        }
      ...
      }, _this._handleOnTabPress = function (_ref5) {
        ...
        if (options.tabBarOnPress) {
          ...
          if (isFocused) {
            if (route.hasOwnProperty('index') && route.index > 0) {
              navigation.dispatch(_core.StackActions.popToTop({ key: route.key }));
            } else {
        ...
        navigation.dispatch(_core.NavigationActions.navigate({
    ...
    _createClass(NavigationView, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(TabView, _extends({}, options, { getLabelText: this._getLabelText, renderIcon: this._renderIcon, renderScene: this._renderScene, onIndexChange: this._handleIndexChange, onTabPress: this._handleOnTabPress, navigation: navigation, descriptors: descriptors, screenProps: screenProps }));
      }
    }]);
  ...
  return function (routes) {
    ...
    var navigator = (0, _core.createNavigator)(NavigationView, router, config);
