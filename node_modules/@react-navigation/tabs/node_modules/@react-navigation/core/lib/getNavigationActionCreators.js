...
var getNavigationActionCreators = function getNavigationActionCreators(route) {
  return {
    ...
    navigate: function navigate(navigateTo, params, action) {
      ...
      (0, _invariant2.default)((typeof navigateTo === 'undefined' ? 'undefined' : _typeof(navigateTo)) === 'object', 'Must navigateTo an object or a string');
    ...
    setParams: function setParams(params) {
      ...
      return _NavigationActions2.default.setParams({ params: params, key: route.key });
    }
  };
};
