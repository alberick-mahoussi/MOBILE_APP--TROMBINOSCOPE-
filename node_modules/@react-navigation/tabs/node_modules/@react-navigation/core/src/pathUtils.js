...
export const createPathParser = (childRouters, routeConfigs, pathConfigs = {}, initialRouteName, initialRouteParams) => {
  ...
  const getPathAndParamsForRoute = route => {
    ...
    const nonPathParams = {};
    if (params) {
      Object.keys(params).filter(paramName => !keys.find(k => k.name === paramName)).forEach(paramName => {
