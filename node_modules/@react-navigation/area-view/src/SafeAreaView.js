...
import { DeviceInfo, Dimensions, InteractionManager, NativeModules, Platform, StyleSheet, Animated } from 'react-native';
...
class SafeView extends Component {
  ...
  render() {
    ...
    return <Animated.View ref={c => this.view = c} onLayout={this._onLayout} style={safeAreaStyle} pointerEvents="box-none">
        {this.props.children}
      </Animated.View>;
  }
